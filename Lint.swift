...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-password open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-password project authors
...
// it only while swift-password and swift-institute-linter-rules are both
...
Lint.run(dependencies: [
    ...
    // If swift-password owns a brand vocabulary, narrow with
